...
PHASE3_DIR = ROOT_DIR / "Phase3_Performance_Optimization"
ENTRY_SCRIPT = PHASE3_DIR / "scripts" / "generate_phase3_results.py"
REQUIREMENTS_FILE = PHASE3_DIR / "requirements.txt"
...
def main() -> None:
    ...
    print("[*] Dependencies found. Running the Objective 3 (Phase 3) results pipeline...")
    print("[*] This produces Phase3_Performance_Optimization/outputs/phase3_results.md — the report to use in your paper.")
    print()
    sys.argv = [str(ENTRY_SCRIPT)]  # generate_phase3_results.py's own argparse defaults apply
