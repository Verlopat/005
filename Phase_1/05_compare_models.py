...
y_tr = train_df[COARSE].astype(str).values
X_te = test_df[feats].astype("float32")
y_te = test_df[COARSE].astype(str).values
y_fine = test_df[FINE].astype(str).values if FINE else None
del train_df
